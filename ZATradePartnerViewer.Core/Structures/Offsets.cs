...
public abstract class Offsets
{
    ...
    public static IReadOnlyList<long> TradePartnerDataPointer { get; } = [0x40FC3D8, 0x1D8, 0x30, 0xA0, 0x0];
    public static IReadOnlyList<long> TradePartnerNIDPointer  { get; } = [0x610D630, 0x108];
